...
//         <div className="quiz-questions-container mt-4 relative">
//           <div className="absolute top-0 left-0 right-0 border-b-[1px] border-dotted border-slate-300">
//             <div
//               className={`${showChallengesTable ? "-translate-x-full" : ""}`}
//             >
//               <h2 className="text-slate-300 font-bold">Including Words</h2>
//               <div className="flex justify-between items-center translate-y-1/2">
...
//               className={`${showChallengesTable ? "" : "-translate-x-full"}`}
//             >
//               {/* <h2 className="text-slate-300 font-bold">Challenges</h2> */}
//               <div className="flex justify-start items-center -translate-y-1/2">
//                 <button
//                   className="p-2 bg-blue-300 text-white"
//                   onClick={() => setShowChallengesTable(false)}
